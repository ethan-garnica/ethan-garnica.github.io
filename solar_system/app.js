...
function loadAssets(onLoadedCB) {
    var filePromises = [
        fetch('../solar_system/shaders/phong.vs.glsl').then((response) => { return response.text(); }),
        fetch('../solar_system/shaders/phong.pointlit.fs.glsl').then((response) => { return response.text(); }),
        fetch('../solar_system/data/sphere.json').then((response) => { return response.json(); }),
        loadImage('../solar_system/data/sun.jpg'),
        loadImage('../solar_system/data/mercury.jpg'),
        loadImage('../solar_system/data/venus.jpg'),
        loadImage('../solar_system/data/earth_daymap.jpg'),
        loadImage('../solar_system/data/moon.jpg'),
        loadImage('../solar_system/data/mars.jpg'),
        loadImage('../solar_system/data/jupiter.jpg'),
        loadImage('../solar_system/data/saturn.jpg'),
        loadImage('../solar_system/data/uranus.jpg'),
        loadImage('../solar_system/data/neptune.jpg'),
        loadImage('../solar_system/data/stars.jpg'),
        loadImage('../solar_system/data/milky_way.jpg')
    ];
